"""
Django settings for project_theater project.
...
ROOT_URLCONF = 'project_theater.urls'
...
WSGI_APPLICATION = 'project_theater.wsgi.application'
...
ASGI_APPLICATION = "project_theater.asgi.application"
